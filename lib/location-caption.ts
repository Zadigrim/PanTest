/**
 * Location caption formatting — mobile MIRROR.
 *
 * CANONICAL: okujiKobo/lib/design/location-caption.ts. That file is the
 * source of truth; this mirror exists ONLY because the mobile tsconfig
 * excludes okujiKobo/ (see tsconfig.json#exclude). Keep these two
 * byte-for-byte in sync — same rule as the stamp date-token mirror.
 */
