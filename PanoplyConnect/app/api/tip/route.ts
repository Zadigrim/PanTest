...
// before transfers work. 100% of tip (minus Stripe fee) goes to creator. Panoply retains zero.
...
export async function POST(request: NextRequest): Promise<NextResponse> {
  ...
  // of tip (minus Stripe fee) directly to the creator. Panoply retains zero.
  ...
  try {
    ...
    if (creatorStripeConnectId) {
      // Connect transfer: 100% of tip goes to creator, Panoply retains zero
