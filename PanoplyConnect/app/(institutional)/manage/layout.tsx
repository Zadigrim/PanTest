...
function NavLink({ href, children }: { href: string; children: ReactNode }) {
  return (
    <Link
      href={href}
      className="flex items-center gap-2.5 px-3 py-2 rounded-panel text-sm font-medium text-panoply-teal-lt/90 hover:bg-white/10 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-panoply-teal"
    >
      {children}
    </Link>
  )
...
async function LogoutButton() {
  ...
  return (
    <form action={signOut}>
      <button
        type="submit"
        className="w-full flex items-center gap-2.5 px-3 py-2 rounded-panel text-sm font-medium text-panoply-teal-lt/70 hover:bg-white/10 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-panoply-teal text-left"
      >
        <svg
          width="16"
          height="16"
      ...
      <aside className="w-60 shrink-0 bg-panoply-navy flex flex-col">
        ...
        <div className="px-3 py-4 border-t border-white/10 space-y-1">
          {authorization.role_label && (
            <p className="px-3 text-xs text-panoply-teal-lt/50 truncate">
              {authorization.role_label}
            </p>
          )}
          <LogoutButton />
