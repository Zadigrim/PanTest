    ...
    <div className="flex items-center gap-2">
      {labels.map((label, i) => (
        <div key={label} className="flex items-center gap-2">
          ...
          <span
            className={`text-xs ${
              i === idx ? 'font-semibold text-panoply-navy' : 'text-panoply-gray-3'
            }`}
          >
            {label}
          </span>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-panoply-gray-3">Set to $0 for a free passport.</p>
      </div>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-2 pt-2">
        ...
        <Button
          size="sm"
          className="flex-1 bg-panoply-teal hover:bg-panoply-teal-dk"
          onClick={onPublish}
          disabled={publishing}
        >
