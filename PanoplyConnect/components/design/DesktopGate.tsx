...
export function DesktopGate({ children }: Props) {
  ...
  if (isTooNarrow) {
    return (
      <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-panoply-navy px-8 text-center">
        <span className="mb-6 text-5xl" aria-hidden="true">
          🖥️
        </span>
        <h1 className="text-xl font-semibold text-[#F5F2EC]">
          PanoplyDesigner requires a desktop browser.
        </h1>
