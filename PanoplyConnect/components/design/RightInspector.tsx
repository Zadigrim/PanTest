              ...
              <div className="flex items-center gap-2">
                ...
                <span
                  className={`text-sm font-medium ${
                    stop.verification_tier === tier ? 'text-panoply-teal-dk' : 'text-panoply-navy'
                  }`}
                >
                  {label}
                </span>
        ...
        <div className="space-y-1.5">
          {PASSPORT_TYPES.map(({ value, label, hint }) => (
            ...
            >
              <p
                className={`text-sm font-medium ${
                  passport.passport_type === value ? 'text-panoply-teal-dk' : 'text-panoply-navy'
                }`}
              >
                {label}
              </p>
