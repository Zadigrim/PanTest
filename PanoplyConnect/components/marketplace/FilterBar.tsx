...
const SELECT_BASE =
  'h-8 cursor-pointer appearance-none rounded-card border border-panoply-gray-2 bg-white ' +
  'pl-3 pr-7 text-xs text-panoply-navy transition-colors ' +
  'hover:border-panoply-teal focus:outline-none focus:ring-2 focus:ring-panoply-teal ' +
...
const SELECT_CARET =
  "pointer-events-none absolute inset-y-0 right-2 flex items-center text-panoply-gray-3"
    ...
    <div ref={ref} className="relative shrink-0">
      <button
        ...
        className={cn(
          ...
          'focus:outline-none focus:ring-2 focus:ring-panoply-teal',
          isActive
            ? 'border-panoply-teal bg-panoply-teal-lt text-panoply-teal-dk font-medium'
            : 'border-panoply-gray-2 bg-white text-panoply-navy hover:border-panoply-teal'
        )}
      ...
      {open && (
        <div
          ...
          aria-label={label}
          className={cn(
            'absolute left-0 top-full z-50 mt-1 min-w-[10rem] rounded-panel border border-panoply-gray-2',
        ...
        >
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  'hover:bg-panoply-gray-1',
                  checked ? 'text-panoply-teal-dk font-medium' : 'text-panoply-navy'
                )}
              >
                <span
                  className={cn(
                    ...
                    checked
                      ? 'border-panoply-teal bg-panoply-teal text-white'
                      : 'border-panoply-gray-3'
                  )}
                  aria-hidden="true"
                >
                  {checked && (
          ...
          {selected.length > 0 && (
            <>
              <hr className="my-1 border-panoply-gray-2" />
              <button
                type="button"
                onClick={() => { onChange([]); setOpen(false) }}
                className="w-full px-3 py-1.5 text-left text-xs text-panoply-gray-3 hover:text-panoply-coral transition-colors"
              >
                Clear all
              </button>
            </>
...
export function FilterBar({ filters, onChange }: FilterBarProps) {
  ...
  return (
    <div
      className={cn(
        'sticky top-0 z-30 bg-white border-b border-panoply-gray-2',
      ...
      <div className="flex items-center gap-2 px-4 py-2 min-w-max">
        ...
        <div className={SELECT_WRAPPER}>
          <select
            ...
            className={cn(
              SELECT_BASE,
              filters.travelerType && 'border-panoply-teal text-panoply-teal-dk font-medium'
            )}
        ...
        {/* ── Divider ─────────────────────────────────────────────────────── */}
        <div className="h-5 w-px shrink-0 bg-panoply-gray-2" aria-hidden="true" />
