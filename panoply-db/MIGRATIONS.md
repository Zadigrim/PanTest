# Panoply Database — Migration Directory

## How to use this document

This is a plain-language guide to the Panoply database. Read it to understand
...
**Purpose:** Complete Panoply schema as of Blockpoint 3. Consolidates migrations
...
**institutions**
Organisations that use PanoplyConnect — schools, libraries, nature centers, McMenamins
...
Who can act on behalf of an institution in PanoplyConnect: verify stamps, distribute
...
processing fee) is transferred to the creator. Panoply retains zero.
...
1. **Platform admin flag.** Adds `is_platform_admin` to profiles and creates the
   ...
   of PanoplyConnect without restriction.
...
*This document is maintained as part of the Panoply development process. Every new
