...
export async function detectRoles(
  ...
  if (profile) {
    ...
    // connect_roles is an array of additional OkujiConnectRole values
    const connectRoles = (profile.connect_roles ?? []) as OkujiConnectRole[]
  ...
  const ROLE_PRIORITY: OkujiConnectRole[] = [
    'platform_admin',
    'institutional_manager',
    'individual_creator',
    'designer',
...
export const ROLE_LABELS: Record<OkujiConnectRole, string> = {
