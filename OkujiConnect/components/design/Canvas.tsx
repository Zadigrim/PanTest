  ...
  if (!activePage) {
    return (
      <div className="flex flex-1 items-center justify-center bg-okuji-gray-1">
        <p className="text-sm text-okuji-gray-3">No page selected</p>
      </div>
    )
  }
          ...
          <PageBackground page={activePage}>
            ...
            {stops.length === 0 && elements.length === 0 && (
              <div className="flex h-full items-center justify-center pointer-events-none">
                <p className="rounded-panel border border-dashed border-okuji-gray-2 px-4 py-2 text-xs text-okuji-gray-3/50">
