export default function AnalyticsPage() {
  return (
    <div className="p-8 max-w-6xl">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-okuji-navy">Analytics</h1>
        <p className="text-sm text-okuji-gray-3 mt-1">Detailed reporting coming soon.</p>
      </div>
      ...
      <div className="rounded-modal border-2 border-dashed border-okuji-gray-2 py-20 text-center">
        ...
        <h2 className="text-lg font-semibold text-okuji-navy">Analytics coming soon</h2>
        <p className="mt-2 text-sm text-okuji-gray-3 max-w-sm mx-auto">
