...
const SECTION_ACCESS: Record<string, OkujiKoboRole[]> = {
...
const NAV_CARDS = [
  {
    ...
    requiresRole: null as OkujiKoboRole | null,
  },
  {
    key:     'manage',
    ...
    requiresRole: 'institutional_manager' as OkujiKoboRole,
  },
  {
    key:     'access',
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
        ...
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-navy">
            {displayName ? `Welcome back, ${displayName}` : 'okujiKobo'}
          </h1>
