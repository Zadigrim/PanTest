    ...
    >
      ...
      <footer className="mt-3 flex items-center justify-between gap-2 border-t border-surface-faintdiv pt-2.5">
        <div className="min-w-0">
          ...
          <p className="mt-0.5 inline-flex items-center gap-1.5 text-[10.5px] text-muted">
            ...
            {stop.comment_count > 0 && (
              <span className="inline-flex items-center gap-1 before:mr-1 before:text-muted before:content-['·']">
                <CommentGlyph />
                {stop.comment_count}
              </span>
            )}
